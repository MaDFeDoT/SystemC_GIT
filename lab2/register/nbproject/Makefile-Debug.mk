...
LDLIBSOPTIONS=`pkg-config --libs systemc`  
...
${OBJECTDIR}/register.o: register.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags systemc`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/register.o register.cpp

${OBJECTDIR}/testbench.o: testbench.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g `pkg-config --cflags systemc`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/testbench.o testbench.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/register
